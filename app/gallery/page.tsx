      ...
      <section style={{ display:'grid', gridTemplateColumns:'repeat(3, 1fr)', gridTemplateRows:'56vh 44vh', gap:'3px', background:'#0A0A0A', paddingTop:'80px' }}>
        ...
        <style>{`
          @media(max-width:700px){
            section:first-of-type{grid-template-columns:1fr 1fr!important;grid-template-rows:50vw 40vw 40vw!important;padding-top:64px!important}
            section:first-of-type>div:nth-child(1){grid-column:1!important;grid-row:1!important}
            section:first-of-type>div:nth-child(2){grid-column:2!important;grid-row:1!important;padding:16px 12px!important}
            section:first-of-type>div:nth-child(2) h1{font-size:26px!important;line-height:.95!important;margin-bottom:8px!important}
            section:first-of-type>div:nth-child(2) p{font-size:10px!important}
            section:first-of-type>div:nth-child(3){grid-column:1!important;grid-row:2!important}
            section:first-of-type>div:nth-child(4){grid-column:2!important;grid-row:2!important}
            section:first-of-type>div:nth-child(5){grid-column:1!important;grid-row:3!important}
            section:first-of-type>div:nth-child(6){grid-column:2!important;grid-row:3!important}
          }
        `}</style>
      </section>
