...
export async function GET(_req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    await sql`CREATE TABLE IF NOT EXISTS ss_blog_comments (id SERIAL PRIMARY KEY, post_id TEXT NOT NULL, name TEXT NOT NULL, body TEXT NOT NULL, created_at TIMESTAMPTZ DEFAULT NOW())`
