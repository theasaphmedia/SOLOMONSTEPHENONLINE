    ...
    <main style={{ background:'#09090E', color:'#F0EDE8', overflowX:'hidden' }}>
      ...
      <section ref={heroRef} style={{ position:'relative', minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
        <div style={{ position:'absolute', inset:0, zIndex:0 }}>
          ...
          <video autoPlay muted loop playsInline style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover', objectPosition:'center center' }}>
        ...
        <div style={{ position:'relative', zIndex:1, textAlign:'center', padding:'clamp(120px,15vw,180px) clamp(24px,6vw,80px) clamp(80px,10vw,120px)', maxWidth:'900px', margin:'0 auto', animation:'fadeUp .9s .2s both' }}>
          ...
          <div style={{ display:'flex', gap:'14px', justifyContent:'center', flexWrap:'wrap' }}>
            ...
            <button className="btn-outline" onClick={() => document.getElementById('gear')?.scrollIntoView({ behavior:'smooth' })}>View Capabilities</button>
          </div>
        </div>
            ...
            <div className="rv d2">
              ...
              <div style={{ display:'flex', flexDirection:'column' }}>
                ...
                <a
                  ...
                  style={{ display:'flex', gap:'14px', padding:'14px 0', borderBottom:'1px solid rgba(255,255,255,.05)', textDecoration:'none', transition:'padding-left .3s', borderRadius:'1px' }}
                ...
                <div style={{ display:'flex', gap:'14px', padding:'14px 0', borderBottom:'1px solid rgba(255,255,255,.05)' }}>
                  ...
                  <div>
                    <div style={{ fontFamily:'DM Sans,sans-serif', fontSize:'9px', letterSpacing:'.22em', textTransform:'uppercase', color:'rgba(201,168,76,.6)', marginBottom:'8px' }}>Phone / WhatsApp</div>
                    <div style={{ display:'flex', gap:'10px', flexWrap:'wrap' }}>
                      <a href="tel:+2348145799098"
                        style={{ fontFamily:'DM Sans,sans-serif', fontSize:'13px', color:'rgba(240,237,232,.65)', textDecoration:'none', padding:'5px 12px', border:'1px solid rgba(255,255,255,.1)', borderRadius:'20px', display:'inline-flex', alignItems:'center', gap:'6px', transition:'all .25s' }}
                ...
                {/* Email */}
                <a href={'mailto:' + EMAIL}
                  style={{ display:'flex', gap:'14px', padding:'14px 0', borderBottom:'1px solid rgba(255,255,255,.05)', textDecoration:'none', transition:'padding-left .3s' }}
                  onMouseEnter={e => (e.currentTarget as HTMLElement).style.paddingLeft = '6px'}
                  onMouseLeave={e => (e.currentTarget as HTMLElement).style.paddingLeft = '0'}
                >
                  <span style={{ color:'#C9A84C', flexShrink:0, marginTop:'1px' }}>
        ...
        <div style={{ maxWidth:'1200px', margin:'0 auto' }}>
          ...
          <div style={{ borderTop:'1px solid rgba(255,255,255,.06)' }}>
            {CAPABILITIES.map((g, i) => (
              <div key={g.name} className="cap-row rv" style={{ transitionDelay:(i*.06)+'s' }}
          ...
          <div className="svc-grid" style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:'1px', background:'rgba(255,255,255,.04)' }}>
            {SERVICES.map((s, i) => (
              <div key={s.id} className="svc-card rv" style={{ transitionDelay:(i*.05)+'s', borderRadius:0, border:'none' }}
                ...
                <div style={{ fontFamily:'DM Sans,sans-serif', fontSize:'18px', color: svcHover===i ? '#C9A84C' : 'rgba(201,168,76,.55)', marginBottom:'16px', transition:'color .3s' }}>{s.icon}</div>
      ...
      <section ref={bookRef as React.RefObject<HTMLElement>} id="book" style={{ background:'#080B08', padding:'clamp(80px,10vw,140px) clamp(24px,4vw,80px)', borderTop:'1px solid rgba(201,168,76,.08)' }}>
        <div style={{ maxWidth:'760px', margin:'0 auto' }}>
          ...
          <p className="rv d2" style={{ fontFamily:'DM Sans,sans-serif', fontSize:'clamp(13px,1.4vw,15px)', lineHeight:1.85, color:'rgba(240,237,232,.38)', margin:'0 0 clamp(40px,5vw,60px)' }}>
            The fastest way to book is a quick WhatsApp message. Tell us what you need — we will confirm your session personally.
          </p>
          ...
          <div className="rv d3" style={{ marginBottom:'clamp(32px,4vw,48px)' }}>
            ...
            <textarea className="b-input" rows={3}
