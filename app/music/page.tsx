  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* ── Stream pills ── */
        .stream-pill{display:inline-flex;align-items:center;gap:7px;padding:10px 20px;font-family:'DM Sans',sans-serif;font-size:11px;font-weight:600;letter-spacing:.06em;text-transform:uppercase;text-decoration:none;border-radius:3px;transition:all .25s cubic-bezier(.16,1,.3,1);white-space:nowrap}
        .stream-spotify{background:#1DB954;color:#000}
        .stream-spotify:hover{background:#1ed760;transform:translateY(-2px);box-shadow:0 8px 24px rgba(29,185,84,.35)}
        .stream-apple{background:#FC3C44;color:#fff}
        .stream-apple:hover{background:#ff4f57;transform:translateY(-2px);box-shadow:0 8px 24px rgba(252,60,68,.35)}
        .stream-youtube{background:rgba(255,255,255,.08);color:rgba(250,247,242,.7);border:1px solid rgba(255,255,255,.12)}
        .stream-youtube:hover{background:rgba(255,255,255,.14);color:#FAF7F2;transform:translateY(-2px)}
        /* ── No-embed overlay ── */
        ...
        <div className="player-grid">
          ...
          <div className="player-left-col" style={{ padding:'clamp(24px,3.5vw,44px)', display:'flex', flexDirection:'column', gap:'20px', borderRight:'1px solid rgba(201,168,76,.07)' }}>
            ...
            <div style={{ display:'flex', gap:'10px', flexWrap:'wrap', paddingTop:'20px', borderTop:'1px solid rgba(201,168,76,.07)', alignItems:'center' }}>
              ...
              <a href="https://open.spotify.com/artist/7l1GQgXjGCQxlXRxIlHnJw" target="_blank" rel="noopener noreferrer" className="stream-pill stream-spotify">
              ...
              <a href="https://music.apple.com/ng/artist/solomon-stephen/1440574453" target="_blank" rel="noopener noreferrer" className="stream-pill stream-apple">
