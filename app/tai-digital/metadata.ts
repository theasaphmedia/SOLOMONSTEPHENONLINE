...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://solomonstephen.com/api/og?title=TAI%20Digital&sub=Creative%20Technology%20Agency', width: 1200, height: 630, alt: 'TAI Digital - Creative Agency' }]
  }
}
